...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "foo@example.com:123456", "bar@example.com:123456"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Bind ui elements and listeners
    ...
    /**
     * Validates email using regrex patterns
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            // TODO: 22/01/17 attempt authentication against a network service. Shoud be replace with a proper Service and not a AsyncTask
